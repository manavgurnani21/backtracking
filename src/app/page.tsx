      ...
      <div className="hero">
        <div className="heroGrid">
          <div>
            ...
            <p className="lede">
              I build ML systems, cloud infrastructure, and the software brains of an autonomous Cadillac. This site is
              the road trip through all of it — scroll to travel the journey, or jump straight to any stop.
            </p>
